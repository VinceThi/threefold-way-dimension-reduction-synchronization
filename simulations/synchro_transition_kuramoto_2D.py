...
# Predictions for the Kuramoto dynamics on modular graphs when one
...
nb_instances = 50
p_out_array = np.linspace(0.1, 0.9, 50)

# Get result
r1_matrix, r2_matrix, R1_matrix, R2_matrix, r_matrix, R_matrix = \
    get_synchro_transition_kuramoto_2D(p_out_array, p_in, sizes, nb_instances,
...
# with open('data/kuramoto/2019_06_19_00h13min39sec_test2'
...
if messagebox.askyesno("Python",
    ...
    f = open('data/kuramoto/{}_{}_kuramoto_2D.txt'.format(timestr, file), 'w')
    f.writelines(
    ...
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_complete_r_matrix_kuramoto_2D.json'.format(timestr,
                                                           p_in, omega1,
                                                           n1, n2, file), 'w'
              ) as outfile:
        json.dump(r_matrix.tolist(), outfile)
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_complete_r1_matrix_kuramoto_2D.json'.format(timestr,
                                                            p_in, omega1,
                                                            n1, n2, file), 'w'
              ) as outfile:
        json.dump(r1_matrix.tolist(), outfile)
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_complete_r2_matrix_kuramoto_2D.json'.format(timestr,
                                                            p_in, omega1,
                                                            n1, n2, file), 'w'
              ) as outfile:
    ...
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_reduced_R_matrix_kuramoto_2D.json'.format(timestr,
                                                          p_in, omega1,
                                                          n1, n2, file), 'w'
              ) as outfile:
        json.dump(R_matrix.tolist(), outfile)
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_reduced_R1_matrix_kuramoto_2D.json'.format(timestr,
                                                           p_in, omega1,
                                                           n1, n2, file), 'w'
              ) as outfile:
        json.dump(R1_matrix.tolist(), outfile)
    with open('data/kuramoto/{}_p_in_{}_omega1_{}_n1_{}_n2_{}_{}'
              '_reduced_R2_matrix_kuramoto_2D.json'.format(timestr,
                                                           p_in, omega1,
                                                           n1, n2, file), 'w'
              ) as outfile:
        json.dump(R2_matrix.tolist(), outfile)
