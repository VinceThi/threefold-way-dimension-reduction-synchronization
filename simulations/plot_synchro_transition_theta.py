...
left_bottom_axis_settings(ax, "$p$", "$R$", x_lim_te, y_lim_te,
...
plot_transitions_complete_vs_reduced(np.linspace(0.01, 1, 50),
                                     ...
                                     "#252525", "#969696",
                                     alpha, marker, s, linewidth, nb_instances)
left_bottom_axis_settings(ax2, "$p_{out}$", "$\\langle R \\rangle_t$", x_lim_ts, y_lim_ts,
                          (0.5, -0.15), (-0.2, 0.45), fontsize,
                          labelsize, linewidth)
