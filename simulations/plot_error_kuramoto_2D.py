...
# with open('data/kuramoto/errors_kuramoto/2019_08_05_15h52min52sec_50_nodes'
#           '_parameters_for_error_kuramoto_2D.json') as json_data:
...
#
# with open('data/kuramoto/errors_kuramoto/2019_08_05_15h52min52sec_50_nodes'
#           '_dataset_for_error_kuramoto_2D.json') as json_data:
...
#     get_marginal_L1_errors(0, nb_omega1, nb_sigma,  # nb_p_out,
#                            L1_matrix, L1_1_matrix, L1_2_matrix)
# L1_p_out_matrix, L1_1_p_out_matrix, L1_2_p_out_matrix =\
#     get_marginal_L1_errors(1, nb_omega1, nb_sigma,  # nb_p_out,
#                            L1_matrix, L1_1_matrix, L1_2_matrix)
# y_limits_RMSE = [0, 0.2]
# y_limits_L1 = [0, 0.2]
#
...
# for i in range(5):
#     plt.plot(sigma_array, L1_p_out_matrix[i], linewidth=linewidth,
...
# for i in range(5):
#     plt.plot(sigma_array, L1_1_p_out_matrix[i], linewidth=linewidth,
#              label=perturbation_list[i])
...
# for i in range(5):
#     plt.plot(sigma_array, L1_2_p_out_matrix[i], linewidth=linewidth,
#              label=perturbation_list[i])
...
# plt.show()
#
# # with open('data/kuramoto/errors_kuramoto/2019_08_04_03h51min28sec_sim1'
# #           '_parameters_for_error_kuramoto_2D.json') as json_data:
# #     parameters_matrix = np.array(json.load(json_data))
# # p_out = parameters_matrix[0]
# # omega1 = parameters_matrix[1]
