...
p_out_array = np.array([0.05])  # np.linspace(1/N, 1, 30)
omega1_array = np.array([0.3])  # np.linspace(0, 1, 30)

R_dictionary = get_uniform_data_winfree_2D(p_out_array, omega1_array,
                                           sizes, t0, t1, dt, sigma,
                                           plot_temporal_series=0,
                                           plot_temporal_series_2=1)
line1 = "t0 = {}\n".format(t0)
line2 = "t1 = {}\n".format(t1)
line3 = "deltat = {}\n".format(dt)
...
#     get_random_data_winfree_2D(sizes, nb_data, omega_min, omega_max,
...
if messagebox.askyesno("Python",
    ...
    f = open('data/winfree/errors_winfree/{}_{}_dataset_informations'
             '_for_error_winfree_2D.txt'.format(timestr, file), 'w')
    f.writelines(
    ...
    with open('data/winfree/errors_winfree/{}_{}_data_parameters_dictionary'
              '_for_error_winfree_2D.json'.format(timestr, file), 'w'
              ) as outfile:
        json.dump(R_dictionary, outfile)

    # with open('data/winfree/errors_winfree/{}_{}_parameters_for'
    #           '_error_winfree_2D.json'.format(timestr, file), 'w'
    #           ) as outfile:
