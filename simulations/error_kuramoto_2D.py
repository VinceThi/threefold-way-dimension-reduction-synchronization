...
p_out_array = np.linspace(1/N, 1, 30)
omega1_array = np.linspace(0, 1, 30)

R_dictionary = get_uniform_data_kuramoto_2D(p_out_array, omega1_array,
...
if messagebox.askyesno("Python",
    ...
    with open('data/kuramoto/errors_kuramoto/{}_{}_data_parameters_dictionary'
              '_for_error_kuramoto_2D.json'.format(timestr, file), 'w'
              ) as outfile:
